...
<form  method="post" name="form1">
  <table>
    ...
    <tbody>
        ...
        <td><input type="submit" value="修改" onclick="document.form1.action='UserClServlet?flag=modify&pageNow=<%=pageNow%>'">&nbsp;
        <input type="reset" value="取消" onclick="return forwardurl(<%=pageNow%>)"></td>
      </tr>
    </tbody>
  </table>
  </form>
